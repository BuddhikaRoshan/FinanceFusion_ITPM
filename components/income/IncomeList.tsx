    ...
    <div className="text-gray-100">
      <div className="flex justify-between items-center mb-4 gap-4 flex-wrap">
        <Input
          ...
          className="md:min-w-[600px] md:w-auto p-2 border rounded bg-gray-700 border-gray-600 text-gray-100 placeholder-gray-400"
        />
      ...
      {!isLoading && filteredIncomes.length === 0 && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="text-center my-4 p-8 border border-dashed rounded-lg border-gray-700 text-gray-400"
        >
          {filter
